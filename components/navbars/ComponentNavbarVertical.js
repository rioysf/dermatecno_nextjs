...
// import routes file
import { DashboardMenu } from 'routes/Routes';

const ComponentNavbarVertical = (props) => {
			...
			<SimpleBar style={{ maxHeight: '100vh' }}>
				<div className="nav-scroller">
					<Link href="/" className="navbar-brand">
						<Image src="/images/brand/logo/dermatecno.jpeg" alt="" className='w-100 h-100'/>
					</Link>
				</div>				
				{/* Dashboard Menu */}
...
export default ComponentNavbarVertical;
