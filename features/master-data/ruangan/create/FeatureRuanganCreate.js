...
export default function FeatureRuanganCreate() {
                                            ...
                                            <Row>
                                                ...
                                                <Col xs={12} md={6}>
                                                    <Form.Group className="mb-3" controlId="name">
                                                        <Form.Label className='fw-bold text-primary form-required-label'>Nama Ruangan</Form.Label>
                                                        <Form.Control className='text-black' type="text" placeholder="Executive A" />
                                                    </Form.Group>
                                                    <Form.Group className="mb-3" controlId="number">
                                                        <Form.Label className='fw-bold text-primary form-required-label'>Nomor Ruangan</Form.Label>
                                                        <Form.Control className='text-black' type="text" placeholder="EA-1" />
                                                    </Form.Group>
                                                    <Form.Group className="mb-3" controlId="bed_capacity">
                                                        <Form.Label className='fw-bold text-primary form-required-label'>Kapasitas Kasur</Form.Label>
