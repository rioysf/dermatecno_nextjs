...
/*
    Import Feature
*/
import { FeaturePasienCreate } from 'features'


export const metadata = {
    title: 'Dermatecno Apps - Buat Pasien',
    description: 'SaaS system that designed especially for you - Aesthetic Clinic',
}

export default function Pasien() {
    const breadcrumb = ['Beranda', 'Pasien', 'Buat Pasien']
    return (
        <Fragment>
            ...
            <Container fluid className="mt-n16 px-6">
                <Row>
                    <Col lg={12} md={12} xs={12}>
                        {/* Page Heading */}
                        <ComponentPageHeading heading={'Buat Pasien'}/>
                        {/* Breadscrumb */}
