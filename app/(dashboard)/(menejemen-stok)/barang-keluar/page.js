...
/*
    Import Feature
*/
import { FeatureBarangKeluar } from 'features'


export const metadata = {
    title: 'Dermatecno Apps - Barang Keluar',
    description: 'SaaS system that designed especially for you - Aesthetic Clinic',
}

export default function JanjiTemu() {
    const breadcrumb = ['Beranda', 'Barang Keluar']
    return (
        <Fragment>
            ...
            <Container fluid className="mt-n16 px-6">
                <Row>
                    <Col lg={12} md={12} xs={12}>
                        {/* Page Heading */}
                        <ComponentPageHeading heading={'Barang Keluar'}/>
                        {/* Breadscrumb */}
